...
def process_document(
    ...
    **kwargs
    ...
    try:
        ...
        file_path = str(file_path) if isinstance(file_path, os.PathLike) else file_path
        ...
        # Initialize the text splitter with LangChain's RecursiveCharacterTextSplitter
        # but use our custom MarkdownAwareTextSplitter for better handling of tables
